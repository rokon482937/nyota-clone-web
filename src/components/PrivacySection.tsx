  ...
  return (
    <section className="py-20 bg-gradient-to-r from-blue-500 to-blue-600 relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white relative z-10">
        ...
        <h2 className="text-4xl lg:text-5xl font-bold mb-8">Privacy by design</h2>
        
        <p className="text-lg lg:text-xl leading-relaxed mb-8 max-w-3xl mx-auto">
        ...
        <div className="inline-flex items-center space-x-3 bg-blue-900 px-6 py-3 rounded-lg">
